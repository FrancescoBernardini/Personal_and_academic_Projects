...
{
 public:
  AF_DCMotor(uint8_t motornum, int motorpin, int voltage, int treshold, uint8_t freq = DC_MOTOR_PWM_RATE);
  //2nd, 3rd and 4th arguments are added by me
  void run(uint8_t);
  void setSpeed(uint8_t);

  ///////////////////////////////////////////////////////////////////////////////////////
  int motorpin; //I added these three variables to be able to define in the same class
  int voltage;  //also the Arduino pin, to store the current voltage of the potentiometer,
  int treshold; //and the treshold that is set for the movement of the motor. In the next 
                //update, I will create set/get methods to handle them.
  ///////////////////////////////////////////////////////////////////////////////////////
 private:
