...
AF_DCMotor::AF_DCMotor(uint8_t num, int pin, int volt, int tres, uint8_t freq) {
  //second, third and fourth parameter are added by me
  motornum = num;

  //////////////////////////////////////////////////////////////////////////
  //These three additional parameters account for motor pin on Arduino, 
  //the current voltage read from the potentiometers, and the user-selected
  //treshold for the precision of the movement.
  motorpin = pin;
  voltage = volt;
  treshold = tres;
  //////////////////////////////////////////////////////////////////////////
